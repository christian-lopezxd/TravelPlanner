...
const EditTripCard = () => {
    ...
    const Create = (e) => {
        ...
        DestinationServices.Edit(formData, navigate);
        ...
        <div className="flex col-span-5 items-center justify-center gap-2  py-5 text-black bg-lightgray min-h-[89.5vh]" >
            <div className='bg-white w-[90%] flex flex-col items-center  gap-4  min-h-[100%] rounded font-montserrat'>
                ...
                <form onSubmit={(e) => Create(e)} className="flex flex-col gap-2 items-center justify-between w-full gap-5 grow">
                    <input value={name} onChange={(e) => SetName(e.target.value)} type="name" className="text-black p-2 ml-5  border-b border-b-black w-[50%]" placeholder="Enter trip name"></input>
                    <div className='w-[100%]  flex items-start justify-center gap-5 '>
                        ...
                        <div className='flex flex-col w-[45%] p-5 gap-3 rounded-xl'>
                            ...
                            <input value={place_of_stay} onChange={(e) => SetPlace_of_stay(e.target.value)} minLength="10" type="text" className="text-black p-2   border rounded border-black " placeholder="Enter a place of stay"></input>
